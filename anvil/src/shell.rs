...
pub fn init_shell<BackendData: Backend + 'static>(display: Rc<RefCell<Display>>, log: ::slog::Logger) -> ShellHandles {
            ...
            match shell_event {
                ...
                XdgRequest::Fullscreen {
                    ...
                    if let Some(geometry) = output_geometry {
                        ...
                        output.with_client_outputs(wl_surface.as_ref().client().unwrap(), |output| { wl_output = Some(output.clone()); });
